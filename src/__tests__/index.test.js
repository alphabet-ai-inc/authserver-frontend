...
jest.mock('../components/apps/Apps', () => ({
...
jest.mock('../components/Databases', () => ({
  Databases: () => <div data-testid="databases">Databases</div>
}));

jest.mock('../components/Roles', () => ({
...
jest.mock('../components/IPs', () => ({
  IPs: () => <div data-testid="ips">IPs</div>
}));

jest.mock('../components/Regions', () => ({
  Regions: () => <div data-testid="regions">Regions</div>
}));

jest.mock('../components/Biometrics', () => ({
