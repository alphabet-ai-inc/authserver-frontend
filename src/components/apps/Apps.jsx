      ...
      <div className="row align-items-center">
        <div className="col">
          ...
          <small className="text-muted">
            {appCount === 0 ? 'No applications found' : `Managing ${appCount} ${appCount === 1 ? 'application' : 'applications'}`}
          </small>
        </div>
...
const Apps = () => {
    ...
    // Replace with actual release options from your backend. See editapp.jsx
    ...
    <>
        ...
        <AppsStickyActionBar
            ...
            onAddNew={handleAddNewApp}
        />
        <div className="container-fluid" style={{ marginTop: '20px' }}>
            {/* REMOVED: Old header section since we have it in sticky bar */}

            {/* Add App Card - Keep this for visual emphasis */}
